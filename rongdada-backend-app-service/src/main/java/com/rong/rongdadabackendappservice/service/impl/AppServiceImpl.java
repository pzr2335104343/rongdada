...
import com.rong.rongdadabackendappservice.mapper.AppMapper;
...
import com.rong.rongdadabackendmodel.dto.app.AppQueryRequest;
import com.rong.rongdadabackendmodel.entity.App;
import com.rong.rongdadabackendmodel.entity.User;
import com.rong.rongdadabackendmodel.enums.AppScoringStrategyEnum;
import com.rong.rongdadabackendmodel.enums.AppTypeEnum;
import com.rong.rongdadabackendmodel.enums.ReviewStatusEnum;
import com.rong.rongdadabackendmodel.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            // AI 得分 类型暂时不开放
            ThrowUtils.throwIf(AppScoringStrategyEnum.getEnumByValue(1).equals(scoringStrategyEnum) && AppTypeEnum.getEnumByValue(0).equals(appTypeEnum),ErrorCode.PARAMS_ERROR,"AI得分类型暂不支持");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
