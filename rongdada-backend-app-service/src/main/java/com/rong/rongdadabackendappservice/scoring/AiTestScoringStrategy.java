package com.rong.rongdadabackendappservice.scoring;
...
import com.rong.rongdadabackendmodel.dto.question.QuestionAnswerDTO;
...
public class AiTestScoringStrategy implements ScoringStrategy {
    ...
    public UserAnswer doScore(List<String> choices, App app) throws Exception {
        ...
        try{
            // 竞争锁
            boolean res = lock.tryLock(1000, 30000, TimeUnit.MILLISECONDS);
            // 未竞争到锁
            if(!res){
                System.out.println("未竞争到锁"+AI_ANSWER_LOCK + cacheKey);
                return null;
            }
            // 竞争到锁
            // 1. 根据 id 查询到题目
