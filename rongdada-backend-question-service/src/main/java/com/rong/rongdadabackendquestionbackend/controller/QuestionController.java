package com.rong.rongdadabackendquestionbackend.controller;
...
import com.rong.rongdadabackendcommon.manager.AiManager;
import com.rong.rongdadabackendmodel.dto.question.*;
...
import com.rong.rongdadabackendquestionbackend.annotation.AuthCheck;
...
public class QuestionController {
    ...
    private static final String GENERATE_RESULT_QUESTION_SYSTEM_MESSAGE = "你是一位严谨的出题专家,我会给你如下信息：\n" +
            ...
            "\n" +
            "请你根据上述信息,按照以下步骤来出题：\n" +
            "1. 要求：题目和选项尽可能地短,题目不要包含序号,题目要很贴合应用名称和应用描述,每题的选项数以我提供的为主,题目不能重复\n" +
